...
app.post("/newSearch", isLoggedIn ,function(req,res){
	...
	request("https://api.spoonacular.com/recipes/search?query="+userSearch+"&number=25&apiKey=6d53692bf5d14e8f93db61d833872edc&limitLicense=true", function(error,response,body){
